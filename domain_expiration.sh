...
## Env preparation
# List of script flags for some protection
set -Eeuo pipefail

# Var that contains full path to script file
...
## Script logic
# Parse scripts args and get expiration time of domain
parse_params "$@"
